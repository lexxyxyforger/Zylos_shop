...
@section('content')
    <div class="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <section class="rounded-3xl border border-slate-200 bg-gradient-to-br from-sky-50 via-white to-amber-50 p-6 shadow-sm sm:p-8">
            ...
            <p class="mt-2 max-w-2xl text-sm text-slate-600">Pantau performa toko, produk, dan aktivitas terbaru dari satu tempat.</p>
        </section>
                        ...
                        <tbody class="divide-y divide-slate-100">
                            @foreach ($recentProducts as $product)
                                <tr class="hover:bg-slate-50/70">
                                    ...
                                    <td class="px-5 py-3 font-semibold text-slate-800">Rp {{ number_format($product->price, 0, ',', '.') }}</td>
